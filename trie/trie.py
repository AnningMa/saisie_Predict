  ...
  def delete_key(self, key):
     def _delete(current_node, word, depth):
       if depth == len(word):
        ...
        if key in current_node.freq_dict:
          del current_node.freq_dict[key]
        # If no children, signal deletion to parent
       ...
       return len(current_node.children) == 0 and not current_node.isEndOfWord
